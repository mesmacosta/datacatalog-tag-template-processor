...
ALLOWED_BOOL_VALUES = ['BOOL', 'BOOLEAN']
ALLOWED_DOUBLE_VALUES = ['DOUBLE', 'FLOAT', 'FLOAT32', 'INT', 'INTEGER', 'NUMBER']
ALLOWED_STRING_VALUES = ['STRING', 'CHAR']
ALLOWED_DATETIME_VALUES = ['TIMESTAMP', 'DATETIME', 'DATE', 'TIME']
ALLOWED_ENUM_VALUES = ['ENUM', 'ENUMERATE', 'ENUMERATED']
